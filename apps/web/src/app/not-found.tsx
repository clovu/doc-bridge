...
const BUGS_URL = 'https://github.com/clovu/doc-bridge/issues'
    ...
    <main className="grid h-screen place-items-center bg-background px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link href={BUGS_URL} target="_blank" className="text-sm font-semibold text-white">{t('button.issue_contact')} <span aria-hidden="true">&rarr;</span></Link>
        </div>
      </div>
    </main>
  )
